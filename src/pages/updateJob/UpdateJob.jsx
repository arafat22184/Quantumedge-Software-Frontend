...
const UpdateJob = () => {
  ...
  const { setAllProjects, allProjects } = useAuth();
  ...
  useEffect(() => {
    const fetchJobData = async () => {
      try {
        ...
        // Set form data with the fetched job data
        setFormData({
          title: jobData.title || "",
          price: jobData.price || "",
          pricingType: jobData.pricingType || "Fixed Price Project",
          description: jobData.description || "",
          location: jobData.location || "Remote",
          experienceLevel: jobData.experienceLevel || "Mid Level",
          vacancy: jobData.vacancy || "1 Freelancer",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update the job in the allProjects state
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#071400]">
